...
class Back extends JFrame {
	...
	public Back() {
		...
		login.setBounds(1300, 600, 100, 100);
		exit.setBounds(1800, 0, 100, 100);
		join.setBounds(900, 750, 85, 50);
		find.setBounds(1000, 750, 140, 50);

		id.setBounds(800,570,100,100);
		pwd.setBounds(800,620,100,100);

		idtext.setBounds(840,600,300,30);
		pwdtext.setBounds(840,650,300,30);
